...
const fadeInVariant = (delay = 0) => ({
    ...
    transition: { type: "spring", stiffness: 60, delay },
});
                ...
                >
                    ...
                    <motion.div {...fadeInVariant(0.1)}>
                        <Text className="mb-4 text-muted-foreground text-lg">
                            Welcome to PlayScope! This privacy policy explains how we collect, use, and protect your information when you use our app.
                        </Text>
                    </motion.div>
                    <motion.div {...fadeInVariant(0.2)}>
                        ...
                        <Text className="mb-2 text-muted-foreground">
                            PlayScope does not collect any personal information from its users. The app is designed to be simple and does not require any data input from you.
                        </Text>
                        <Text className="mb-2 text-muted-foreground">
                            The only information collected is for the purpose of serving advertisements via Unity Ads, and for analytics and performance monitoring.
                        </Text>
                    </motion.div>
                    <motion.div {...fadeInVariant(0.3)}>
                        ...
                        <Text className="mb-2 text-muted-foreground">
                            PlayScope uses Google Analytics, Google Performance, and Crashlytics to help us understand app usage, monitor performance, and improve stability. These services may collect non-personal information such as device type, usage statistics, and crash reports.
                        </Text>
                        <Text className="mb-2 text-muted-foreground">
                            Data collected by these services is used solely to improve the app experience and is not shared with third parties except as required for analytics and diagnostics.
                        </Text>
                    </motion.div>
                    <motion.div {...fadeInVariant(0.4)}>
                        ...
                        <Text className="mb-2 text-muted-foreground">
                            PlayScope uses Unity Ads to serve advertisements. Unity Ads may collect certain information to display relevant ads. Please refer to{" "}
                            <Link
                        ...
                        <Text className="mb-2 text-muted-foreground">
                            The information collected by Unity Ads is used solely for ad-serving purposes and is not shared with any third parties beyond what is necessary for the operation of the ad network.
                        </Text>
                    </motion.div>
